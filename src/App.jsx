...
function App() {
  ...
  return (
    <div className="bg-[#FFF8ED] text-black font-sans relative">
      ...
      <section className="bg-[#FF7A00] text-white text-center py-10">
        ...
        <button
          ...
          className="mt-4 bg-white text-[#FF7A00] font-bold px-6 py-2 rounded-full shadow-lg hover:bg-orange-100"
        >
          Book a Clean
        </button>
      </section>
